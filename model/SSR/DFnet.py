...
class get_model(nn.Module):
    def __init__(self, args):
        ...
        self.ADAM_1 = ADAM(channel, args.angRes_in)
        self.ADAM_2 = ADAM(channel, args.angRes_in)
        self.ADAM_3 = ADAM(channel, args.angRes_in)
        self.Reconstruct = CascadedBlocks(n_blocks, 4*channel)
        self.UpSample = Upsample(channel, args.scale_factor)
